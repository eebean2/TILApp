...
struct UsersController: RouteCollection {
    func boot(router: Router) throws {
        ...
        let tokenAuthMiddlware = User.tokenAuthMiddleware()
        let guardAuthMiddlware = User.guardAuthMiddleware()
        let tokenAuthGroup = usersRoute.grouped(tokenAuthMiddlware, guardAuthMiddlware)
